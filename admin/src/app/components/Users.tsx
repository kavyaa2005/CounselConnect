...
const allUsers = [
  { id: 1, name: "Sarah Chen", email: "sarah.chen@email.com", phone: "+1 (555) 234-5678", joined: "Jan 15, 2026", status: "Active", avatar: "SC", sessions: 12, location: "New York, NY", age: 28, gender: "Female", lastActive: "2 min ago" },
  { id: 2, name: "Michael Johnson", email: "m.johnson@email.com", phone: "+1 (555) 345-6789", joined: "Feb 3, 2026", status: "Active", avatar: "MJ", sessions: 8, location: "Los Angeles, CA", age: 35, gender: "Male", lastActive: "1 hr ago" },
  { id: 3, name: "Emma Davis", email: "emma.davis@email.com", phone: "+1 (555) 456-7890", joined: "Feb 18, 2026", status: "Suspended", avatar: "ED", sessions: 3, location: "Chicago, IL", age: 26, gender: "Female", lastActive: "3 days ago" },
  { id: 4, name: "David Wilson", email: "d.wilson@email.com", phone: "+1 (555) 567-8901", joined: "Mar 5, 2026", status: "Active", avatar: "DW", sessions: 21, location: "Houston, TX", age: 42, gender: "Male", lastActive: "20 min ago" },
  { id: 5, name: "Maria Garcia", email: "maria.g@email.com", phone: "+1 (555) 678-9012", joined: "Mar 22, 2026", status: "Active", avatar: "MG", sessions: 15, location: "Phoenix, AZ", age: 31, gender: "Female", lastActive: "5 min ago" },
  { id: 6, name: "James Martinez", email: "j.martinez@email.com", phone: "+1 (555) 789-0123", joined: "Apr 8, 2026", status: "Inactive", avatar: "JM", sessions: 1, location: "Philadelphia, PA", age: 29, gender: "Male", lastActive: "2 weeks ago" },
  { id: 7, name: "Olivia Brown", email: "o.brown@email.com", phone: "+1 (555) 890-1234", joined: "Apr 25, 2026", status: "Active", avatar: "OB", sessions: 7, location: "San Antonio, TX", age: 38, gender: "Female", lastActive: "1 day ago" },
  { id: 8, name: "William Lee", email: "w.lee@email.com", phone: "+1 (555) 901-2345", joined: "May 12, 2026", status: "Active", avatar: "WL", sessions: 18, location: "San Diego, CA", age: 45, gender: "Male", lastActive: "3 hr ago" },
  { id: 9, name: "Sophia Anderson", email: "s.anderson@email.com", phone: "+1 (555) 012-3456", joined: "May 30, 2026", status: "Active", avatar: "SA", sessions: 9, location: "Dallas, TX", age: 33, gender: "Female", lastActive: "45 min ago" },
  { id: 10, name: "Liam Taylor", email: "l.taylor@email.com", phone: "+1 (555) 123-4567", joined: "Jun 10, 2026", status: "Pending", avatar: "LT", sessions: 0, location: "Jacksonville, FL", age: 24, gender: "Male", lastActive: "Just now" },
  { id: 11, name: "Ava Thomas", email: "a.thomas@email.com", phone: "+1 (555) 234-5679", joined: "Jun 15, 2026", status: "Active", avatar: "AT", sessions: 4, location: "Austin, TX", age: 27, gender: "Female", lastActive: "10 min ago" },
  { id: 12, name: "Noah Jackson", email: "n.jackson@email.com", phone: "+1 (555) 345-6780", joined: "Jun 20, 2026", status: "Pending", avatar: "NJ", sessions: 0, location: "Columbus, OH", age: 30, gender: "Male", lastActive: "Just now" },
];
...
const avatarColors = ["#5E8B7E", "#2D6A4F", "#D8A48F", "#42A5F5", "#F59E0B", "#EF5350", "#8B5CF6", "#06B6D4", "#EC4899", "#10B981", "#F97316", "#6366F1"];

type SortKey = "name" | "email" | "joined" | "status" | "sessions";

const appointmentHistory = [
  { id: "A-2831", type: "Anxiety Management", counselor: "Dr. Sarah Lee", date: "Jun 20", status: "Completed" },
  { id: "A-2796", type: "Anxiety Management", counselor: "Dr. Sarah Lee", date: "Jun 6", status: "Completed" },
  { id: "A-2743", type: "Stress Therapy", counselor: "Dr. James Park", date: "May 23", status: "Completed" },
];

const docList = ["Insurance Card.pdf", "ID Verification.jpg", "Consent Form.pdf"];
    ...
    <div className="p-6 space-y-5" style={{ fontFamily: "'Inter', sans-serif", background: t.bg, minHeight: "100vh" }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-1.5 px-3 py-2 rounded-xl border text-sm hover:opacity-80 transition-colors"
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity"
                          ...
                          <button className="w-7 h-7 rounded-lg flex items-center justify-center transition-colors" title="Edit"
                            style={{ background: "#F0F7F5" }}>
                            <Edit2 className="w-3.5 h-3.5" style={{ color: "#5E8B7E" }} />
                          </button>
                          <button className="w-7 h-7 rounded-lg flex items-center justify-center transition-colors" title="Suspend"
            ...
            >
              ...
              <div className="relative h-32 shrink-0"
                ...
                <div className="absolute -bottom-12 left-6">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-white text-2xl font-bold border-4 shadow-lg"
                    style={{ background: avatarColors[selectedUser.id % avatarColors.length], borderColor: t.card }}>
                    {selectedUser.avatar}
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 pt-14 pb-4 border-b" style={{ borderColor: t.border }}>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs mt-0.5" style={{ color: t.muted }}>User ID: #U-00{selectedUser.id}</p>
                  </div>
                  <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium mt-1"
                    style={{ background: statusConfig[selectedUser.status].bg, color: statusConfig[selectedUser.status].color }}>
                    <span className="w-1.5 h-1.5 rounded-full" style={{ background: statusConfig[selectedUser.status].dot }} />
                    {selectedUser.status}
                  </span>
                </div>
              </div>
                      ...
                      {appointmentHistory.map(a => (
                        <div key={a.id} className="p-3.5 rounded-xl border" style={{ borderColor: t.border, background: t.card2 }}>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-xs px-2 py-0.5 rounded-full" style={{ background: "#EAF7EA", color: "#4CAF50" }}>{a.status}</span>
                          </div>
              ...
              <div className="px-6 py-4 border-t flex gap-2" style={{ borderColor: t.border }}>
                ...
                <button className="px-4 py-2.5 rounded-xl text-sm font-semibold border"
            ...
            >
              <div className="rounded-2xl p-6 max-w-sm w-full shadow-2xl" style={{ background: t.card }}>
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={() => { setConfirmDelete(null); setSelectedUser(null); }}
                    className="flex-1 py-2.5 rounded-xl text-sm font-semibold text-white"
                    style={{ background: "#EF5350" }}>Delete Forever</button>
                </div>
              </div>
            </motion.div>
          </>
